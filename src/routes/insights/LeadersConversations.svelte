<script lang="ts">
    ...
    let conversationsThumbails = [
        {
            image: '/images/john-okeke-thumbnail.jpg',
            caption: 'Service Desk Manager, Service delivery and support - John Okeke',
            videoId: 'VbKe0X7ZqyQ',
        },
        {
            image: '/images/austin-okere-thumbnail.jpg',
            caption: 'Founder, CWG - Austin Okere',
            videoId: 'SxikgRut_lM',
        },
        {
            image: '/images/adewale-adeyipo-thumbnail.jpg',
            caption: 'Group Managing Director, CWG  -  Adewale Adeyipo',
            videoId: 'tVvlYRKbOSw',
        },
        {
            image: '/images/john-okeke-thumbnail.jpg',
...
<div class="relative">
    {#if browser}
        <Carousel
            ...
            particlesToScroll={2}
        >
            {#each conversationsThumbails as conversation}
                <div class="slider bg-midnight-blue">
                    <!-- svelte-ignore a11y-click-events-have-key-events -->
                    <div class="slider-img-wrapper" on:click={() => openModal(conversation.videoId)}>
                        <img src={conversation.image} alt="Slide" class="slider-img" />
                        <img src="/images/play-btn.svg" alt="play" class="play-icon">
                    </div>
                    <div class="slider-caption p-5">{conversation.caption}</div>
                </div>
            {/each}
...
{#if showModal}
    ...
    <div class="modal" on:click={closeModal}>
        <iframe src={`https://www.youtube.com/embed/${currentVideoId}`} title="Video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
{/if}
