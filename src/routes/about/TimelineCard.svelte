...
<div class="min-w-[405px] w-full" class:last-card={isLastItem} class:first-card={isFirstItem}>
	<div class="bg-whitish-blue dark:bg-white/10 h-[460px] pt-7 pl-6 pr-8">
		<div class="mb-4 flex items-center justify-between">
			<h4 class="text-headline-4">CWG Founded</h4>
			<div class="text-body-m">→ 1992</div>
		</div>
		<p class="text-body-m">
