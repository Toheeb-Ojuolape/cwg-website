<script>
    ...
    const commonClasses = "logos-wrapper flex flex-wrap gap-[40px] max-w-[1380px] m-auto justify-center px-5 dark:dark-wrapper";
...
<div class={showMore ? `${commonClasses} show-more` : `${commonClasses}`}>
    ...
    <img src="/images/oem/check-point.svg" alt="check-point" class="partner-logo dark:hidden block">
    <img src="/images/oem/check-point-white.svg" alt="check-point" class="partner-logo dark:block hidden">
...
<!--=== Toggle Button ===-->
<button on:click={toggleSeeMore} class={showMore ? `${commonToggleBtnClass} see-more` : `${commonToggleBtnClass}`}>
