		...
		<div class="box-container">
            <div class="header-text-wrapper">
                ...
                <p class="mb-9 header-title-desc">
                    Take a look at our range of IT services, including our professional services
                    and CWG's platforms, and let's discuss further.
                </p>
            </div>
        </div>
	</header>
        ...
        <div class="section-container">
            <div class="services-grid-wrapper">
                ...
                <a href="/services/e-government-solution" class="servics-block bg-greyish-blue">
                    ...
                    <div class="services-text flex justify-between">
                        <span>E-Government Solution</span>
                        <div class="arrow-right">
                            <ArrowRightLong fillClassName="fill-white" />
                        </div>
                    </div>
                ...
                <a href="/services/payment-terminal-solution" class="servics-block bg-greyish-blue">
                    ...
                    <div class="services-text flex justify-between">
                        <span>Payment Terminal Solution</span>
                        <div class="arrow-right">
                            <ArrowRightLong fillClassName="fill-white" />
                        </div>
                    </div>
                ...
                <a href="/services/colocation" class="servics-block bg-greyish-blue">
                    ...
                    <div class="services-text flex justify-between">
                        <span>Data Center Colocation Service</span>
                        <div class="arrow-right">
                            <ArrowRightLong fillClassName="fill-white" />
                        </div>
                    </div>
